...
import { normalizeOracleFixture, ORACLE_FIXTURE_SCHEMA_VERSION } from "../../../src/workflows/compat/oracle-fixtures.js";
...
async function loadManifest(): Promise<Manifest> {
  const path = join(process.cwd(), "tests", "workflows", "compat", "fixtures", "2.1.212", "manifest.json");
